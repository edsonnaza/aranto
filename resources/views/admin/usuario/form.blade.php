...
<div class="form-group row">
    ...
    <div class="col-lg-5">
        <input type="file" name="foto_up" id="foto" data-initial-preview="{{isset($data->foto) ? Storage::url("imagenes/usuarios/$data->foto") : "http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=Usuario+Perfil"}}" accept="image/*"/>
    </div>
</div>
